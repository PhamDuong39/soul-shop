...
public static class ExtendableObjectExtensions
{
    public static T GetData<T>(this IExtendableObject extendableObject, string name, bool handleType = false)
    {
        ...
        if (extendableObject == null) throw new ArgumentNullException(nameof(extendableObject));
    ...
    private static T GetData<T>(this IExtendableObject extendableObject, string name, JsonSerializer jsonSerializer)
    {
        CheckNotNull(extendableObject, name);
    ...
    private static void SetData<T>(this IExtendableObject extendableObject, string name, T value,
