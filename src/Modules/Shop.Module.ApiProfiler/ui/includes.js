    ...
    function keyHandler(handleObj) {
        ...
        handleObj.handler = function (event) {
            ...
            if (special) {
                ...
                possible[modif + character] = !0;
                possible[modif + jQuery.hotkeys.shiftNums[character]] = !0;
                if (modif === "shift+") {
                    possible[jQuery.hotkeys.shiftNums[character]] = !0
                }
            }
...
(function () {
    ...
    !function (e) {
        ...
        var E = [], x = Object.keys, y = {}, L = {}, k = /^(no-?highlight|plain|text)$/i,
            B = /\blang(?:uage)?-([\w-]+)\b/i, M = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, C = "</span>",
    ...
    hljs.registerLanguage("java", function (e) {
        var a = "[a-zA-Z_$][a-zA-Z_$0-9]*", t = a + "(<" + a + "(\\s*,\\s*" + a + ")*>)?",
