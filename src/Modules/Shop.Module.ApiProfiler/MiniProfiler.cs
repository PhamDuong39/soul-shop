...
public partial class MiniProfiler
{
    ...
    public string CustomLinksJson
    {
        ...
        set
        {
            if (value.HasValue()) CustomLinks = value.FromJson<Dictionary<string, string>>();
        }
    }
    ...
    {
        return json.FromJson<MiniProfiler>();
    }
    ...
    {
        return obj is MiniProfiler miniProfiler && Id.Equals(miniProfiler.Id);
    }
