...
namespace Soul.Shop.Module.Catalog.Data;
    ...
    public void Build(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AppSetting>().HasData(
            new AppSetting("Catalog.ProductPageSize")
                { Module = module, IsVisibleInCommonSettingPage = true, Value = "10" }
        );
        modelBuilder.Entity<ProductOption>().HasIndex(b => b.Name);
        modelBuilder.Entity<ProductOption>().HasData(
            new ProductOption
            {
                Id = 1,
                Name = "Color",
                DisplayType = OptionDisplayType.Color,
        ...
        modelBuilder.Entity<EntityType>().HasData(
            new EntityType()
            {
                Id = (int)EntityTypeWithId.Category, Name = EntityTypeWithId.Category.GetDisplayName(),
                Module = module, IsMenuable = true
            },
            new EntityType()
            {
                Id = (int)EntityTypeWithId.Brand, Name = EntityTypeWithId.Brand.GetDisplayName(), Module = module,
                IsMenuable = true
            },
            new EntityType()
            {
                Id = (int)EntityTypeWithId.Product, Name = EntityTypeWithId.Product.GetDisplayName(),
                Module = module, IsMenuable = false
            }
        );
    }
}