...
public class Review : EntityBase
{
    ...
    /// </summary>
    public ReviewSourceType? SourceType { get; set; set; }

    public bool IsAnonymous { get; set; set; }

    public int SupportCount { get; set; set; }

    /// <summary>
    /// Whether comments are automatically generated by the system
    /// </summary>
