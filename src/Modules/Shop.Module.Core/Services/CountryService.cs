...
public class CountryService : ICountryService
{
    ...
    {
        await Task.Run(() => { _cache.Remove(_provincesKey + countryId); });
    }
    ...
    public void ProvincesTransformToStringArray(IList<StateOrProvinceDto> provinces, int stateOrProvinceId,
