...
public class TokenService : ITokenService
{
    ...
    public ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
    {
        ...
        if (!(securityToken is JwtSecurityToken jwtSecurityToken) || !string.Equals(jwtSecurityToken.Header.Alg,
                SecurityAlgorithms.HmacSha256, StringComparison.InvariantCultureIgnoreCase)) return null;
