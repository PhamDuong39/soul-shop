...
public class Country : EntityBase
{
    ...
    [Required] [StringLength(450)] public string TwoLetterIsoCode { get; set; }

    [Required] public string ThreeLetterIsoCode { get; set; }

    [Required] public int NumericIsoCode { get; set; }
