...
public class ProductService : IProductService
{
    ...
    public async Task<GoodsGetResult> GetGoodsByCache(int id)
    {
        ...
        var result =
            await _staticCacheManager.GetAsync(CatalogKeys.GoodsById + id, async () => { return await GetGoods(id); });
    ...
    public async Task<GoodsGetResult> GetGoods(int id)
    {
        ...
        var productImages = product.Medias.Where(x => x.Media.MediaType == MediaType.Image).OrderBy(c => c.DisplayOrder)
            .Take(10);
