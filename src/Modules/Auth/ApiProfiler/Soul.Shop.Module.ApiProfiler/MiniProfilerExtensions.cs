...
/// <summary>
/// Contains helper methods that ease working with null <see cref="Soul.Shop.Module.ApiProfiler.MiniProfiler"/>s.
/// </summary>
public static class MiniProfilerExtensions
{
    /// <summary>
    /// Wraps <paramref name="selector"/> in a <see cref="Step(Soul.Shop.Module.ApiProfiler.MiniProfiler, string)"/> call and executes it, returning its result.
    /// </summary>
    ...
    /// <see cref="Soul.Shop.Module.ApiProfiler.MiniProfiler.CustomLinks"/> dictionary; will be displayed on the client in the bottom of the profiler popup.
    /// </summary>
