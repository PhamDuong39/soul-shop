...
public static class ServiceCollectionExtensions
{
    ...
    public static void AddCsaApiProfiler(this IServiceCollection services,
        Action<MiniProfilerOptions> configureOptions = null)
    {
        ...
        services.Configure<MiniProfilerOptions>(o => Soul.Shop.Module.ApiProfiler.MiniProfiler.Configure(o));
...
internal class MiniProfilerOptionsDefaults : IConfigureOptions<MiniProfilerOptions>
{
    ...
    {
        if (options.Storage == null) options.Storage = new MemoryCacheStorage(_cache, TimeSpan.FromMinutes(30));
    }
}
