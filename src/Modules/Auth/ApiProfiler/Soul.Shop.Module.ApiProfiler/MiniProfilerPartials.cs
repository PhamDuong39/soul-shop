...
public partial class MiniProfiler
{
    ...
    /// For example, every <see cref="Soul.Shop.Module.ApiProfiler.MiniProfiler"/> deserialized from a store would have these settings.
    /// </summary>
    public static MiniProfilerBaseOptions DefaultOptions { get; private set; } = new();
