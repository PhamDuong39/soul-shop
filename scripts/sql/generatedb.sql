...
(
    Id          int auto_increment
        primary key,
    Name        varchar(450) collate utf8mb4_general_ci not null,
    Slug        varchar(450) collate utf8mb4_general_ci not null,
    Description longtext collate utf8mb4_general_ci     null,
...
(
    ...
    Value       varchar(450) collate utf8mb4_general_ci not null,
    Description longtext collate utf8mb4_general_ci     null,
    IsPublished tinyint(1)                              not null,
    IsDeleted   tinyint(1)                              not null,
    CreatedOn   datetime(6)                             not null,
...
(
    ...
    Value       varchar(450) collate utf8mb4_general_ci not null,
    Display     varchar(450) collate utf8mb4_general_ci null,
    Description longtext collate utf8mb4_general_ci     null,
    IsPublished tinyint(1)                              not null,
    IsDeleted   tinyint(1)                              not null,
    CreatedOn   datetime(6)                             not null,
...
(
    Id        int auto_increment
        primary key,
    Name      longtext collate utf8mb4_general_ci null,
    IsDeleted tinyint(1)                          not null,
    CreatedOn datetime(6)                         not null,
    UpdatedOn datetime(6)                         not null
);
...
(
    Id                           varchar(255) collate utf8mb4_general_ci not null
        primary key,
    Module                       varchar(450) collate utf8mb4_general_ci null,
    FormatType                   int                                     not null,
    Type                         varchar(450) collate utf8mb4_general_ci null,
    Value                        longtext collate utf8mb4_general_ci     null,
    IsVisibleInCommonSettingPage tinyint(1)                              not null,
    Note                         varchar(450) collate utf8mb4_general_ci null
);
...
(
    Id                 int auto_increment
        primary key,
    Name               varchar(450) collate utf8mb4_general_ci not null,
    TwoLetterIsoCode   varchar(450) collate utf8mb4_general_ci not null,
    ThreeLetterIsoCode longtext collate utf8mb4_general_ci     not null,
...
(
    Id        int auto_increment
        primary key,
    `From`    longtext collate utf8mb4_general_ci     not null,
    `To`      longtext collate utf8mb4_general_ci     null,
    Cc        longtext collate utf8mb4_general_ci     null,
    Bcc       longtext collate utf8mb4_general_ci     null,
    Subject   longtext collate utf8mb4_general_ci     null,
    Body      longtext collate utf8mb4_general_ci     null,
    IsHtml    tinyint(1)                              not null,
    OutId     varchar(450) collate utf8mb4_general_ci null,
    ReceiptId varchar(450) collate utf8mb4_general_ci null,
    IsSucceed tinyint(1)                              not null,
    Message   longtext collate utf8mb4_general_ci     null,
    IsDeleted tinyint(1)                              not null,
    CreatedOn datetime(6)                             not null,
    UpdatedOn datetime(6)                             not null
);
...
(
    ...
    Module     varchar(450) collate utf8mb4_general_ci not null
);
...
(
    Id        int auto_increment
        primary key,
    Caption   varchar(450) collate utf8mb4_general_ci null,
    FileSize  int                                     not null,
    FileName  varchar(450) collate utf8mb4_general_ci not null,
    Url       longtext collate utf8mb4_general_ci     null,
    Path      longtext collate utf8mb4_general_ci     null,
    Host      varchar(450) collate utf8mb4_general_ci null,
    Hash      varchar(450) collate utf8mb4_general_ci null,
    Md5       varchar(32) collate utf8mb4_general_ci  null,
...
(
    ...
    Name            varchar(450) collate utf8mb4_general_ci not null,
    Slug            varchar(450) collate utf8mb4_general_ci not null,
    MetaTitle       longtext collate utf8mb4_general_ci     null,
    MetaKeywords    longtext collate utf8mb4_general_ci     null,
    MetaDescription longtext collate utf8mb4_general_ci     null,
    Description     longtext collate utf8mb4_general_ci     null,
    DisplayOrder    int                                     not null,
    IsPublished     tinyint(1)                              not null,
...
(
    Id               int auto_increment
        primary key,
    Name             varchar(256) collate utf8mb4_general_ci null,
    NormalizedName   varchar(256) collate utf8mb4_general_ci null,
...
(
    Id            int auto_increment
        primary key,
    PhoneNumber   varchar(450) collate utf8mb4_general_ci not null,
    Value         varchar(450) collate utf8mb4_general_ci null,
    SignName      varchar(450) collate utf8mb4_general_ci null,
    TemplateType  int                                     null,
    TemplateCode  varchar(450) collate utf8mb4_general_ci null,
    TemplateParam longtext collate utf8mb4_general_ci     null,
    OutId         varchar(450) collate utf8mb4_general_ci null,
    ReceiptId     varchar(450) collate utf8mb4_general_ci null,
...
(
    ...
    Code         varchar(450) collate utf8mb4_general_ci null,
    Name         varchar(450) collate utf8mb4_general_ci not null,
    Level        int                                     not null,
    DisplayOrder int                                     not null,
    IsPublished  tinyint(1)                              not null,
...
(
    Id                int auto_increment
        primary key,
    ContactName       longtext collate utf8mb4_general_ci null,
    Phone             longtext collate utf8mb4_general_ci null,
    AddressLine1      longtext collate utf8mb4_general_ci null,
    AddressLine2      longtext collate utf8mb4_general_ci null,
    City              longtext collate utf8mb4_general_ci null,
    ZipCode           longtext collate utf8mb4_general_ci null,
    Email             longtext collate utf8mb4_general_ci null,
    Company           longtext collate utf8mb4_general_ci null,
...
(
    Id                       int auto_increment
        primary key,
    UserName                 varchar(256) collate utf8mb4_general_ci null,
    NormalizedUserName       varchar(256) collate utf8mb4_general_ci null,
    Email                    varchar(256) collate utf8mb4_general_ci null,
    NormalizedEmail          varchar(256) collate utf8mb4_general_ci null,
    EmailConfirmed           tinyint(1)                              not null,
    PasswordHash             longtext collate utf8mb4_general_ci     null,
    SecurityStamp            longtext collate utf8mb4_general_ci     null,
    ConcurrencyStamp         longtext collate utf8mb4_general_ci     null,
    PhoneNumber              varchar(255) collate utf8mb4_general_ci null,
    ...
    FullName                 varchar(450) collate utf8mb4_general_ci not null,
    DefaultShippingAddressId int                                     null,
    DefaultBillingAddressId  int                                     null,
    RefreshTokenHash         longtext collate utf8mb4_general_ci     null,
    Culture                  longtext collate utf8mb4_general_ci     null,
    ExtensionData            longtext collate utf8mb4_general_ci     null,
    IsActive                 tinyint(1)                              not null,
    LastIpAddress            varchar(450) collate utf8mb4_general_ci null,
    LastLoginOn              datetime(6)                             null,
    LastActivityOn           datetime(6)                             null,
    AvatarUrl                varchar(450) collate utf8mb4_general_ci null,
    AvatarId                 int                                     null,
    AdminRemark              varchar(450) collate utf8mb4_general_ci null,
    IsDeleted                tinyint(1)                              not null,
    CreatedOn                datetime(6)                             not null,
    UpdatedOn                datetime(6)                             not null,
...
(
    ...
    UserId              int                                     not null,
    Id                  int                                     not null,
    UnionId             varchar(450) collate utf8mb4_general_ci null,
    IsDeleted           tinyint(1)                              not null,
    CreatedOn           datetime(6)                             not null,
    UpdatedOn           datetime(6)                             not null,
...
(
    Id                int auto_increment
        primary key,
    Name              varchar(450) collate utf8mb4_general_ci not null,
    ViewComponentName longtext collate utf8mb4_general_ci     null,
    CreateUrl         longtext collate utf8mb4_general_ci     null,
    EditUrl           longtext collate utf8mb4_general_ci     null,
    IsPublished       tinyint(1)                              not null,
    CreatedOn         datetime(6)                             not null
);
...
(
    ...
    HtmlData     longtext collate utf8mb4_general_ci null,
    IsDeleted    tinyint(1)                          not null,
    CreatedOn    datetime(6)                         not null,
    UpdatedOn    datetime(6)                         not null,
...
(
    Id        int auto_increment
        primary key,
    UserId    int                                     null,
    Contact   longtext collate utf8mb4_general_ci     null,
    Title     varchar(450) collate utf8mb4_general_ci null,
    Content   varchar(450) collate utf8mb4_general_ci null,
    Type      int                                     not null,
    IsDeleted tinyint(1)                              not null,
    CreatedOn datetime(6)                             not null,
    UpdatedOn datetime(6)                             not null,
...
(
    ...
    Name        varchar(450) collate utf8mb4_general_ci not null,
    AddressId   int                                     not null,
    AdminRemark longtext collate utf8mb4_general_ci     null,
    IsDeleted   tinyint(1)                              not null,
    CreatedOn   datetime(6)                             not null,
    UpdatedOn   datetime(6)                             not null,
...
(
    ...
    RefundReason         longtext collate utf8mb4_general_ci     null,
    ...
    CouponCode           longtext collate utf8mb4_general_ci     null,
    CouponRuleName       longtext collate utf8mb4_general_ci     null,
    SubTotal             decimal(65, 30)                         not null,
    SubTotalWithDiscount decimal(65, 30)                         not null,
    OrderTotal           decimal(65, 30)                         not null,
    DiscountAmount       decimal(65, 30)                         not null,
    OrderNote            varchar(450) collate utf8mb4_general_ci null,
    AdminNote            varchar(450) collate utf8mb4_general_ci null,
    CancelReason         varchar(450) collate utf8mb4_general_ci null,
    OnHoldReason         varchar(450) collate utf8mb4_general_ci null,
...
(
    ...
    OrderSnapshot longtext collate utf8mb4_general_ci null,
    Note          longtext collate utf8mb4_general_ci null,
    CreatedById   int                                 not null,
    UpdatedById   int                                 not null,
    IsDeleted     tinyint(1)                          not null,
    CreatedOn     datetime(6)                         not null,
...
(
    ...
    UserId       int                                     not null,
    Title        varchar(450) collate utf8mb4_general_ci null,
    Comment      varchar(450) collate utf8mb4_general_ci null,
    Rating       int                                     not null,
    ReviewerName varchar(450) collate utf8mb4_general_ci null,
    Status       int                                     not null,
    EntityTypeId int                                     not null,
    EntityId     int                                     not null,
    SourceId     int                                     null,
...
(
    ...
    UserId       int                                     not null,
    Comment      varchar(450) collate utf8mb4_general_ci null,
    ReplierName  varchar(450) collate utf8mb4_general_ci null,
    ToUserId     int                                     null,
    ToUserName   varchar(450) collate utf8mb4_general_ci null,
    Status       int                                     not null,
    IsAnonymous  tinyint(1)                              not null,
    SupportCount int                                     not null,
    IsDeleted    tinyint(1)                              not null,
...
(
    ...
    TrackingNumber varchar(450) collate utf8mb4_general_ci null,
    ShippedOn      datetime(6)                             null,
    DeliveredOn    datetime(6)                             null,
    AdminComment   longtext collate utf8mb4_general_ci     null,
    CreatedById    int                                     not null,
    UpdatedById    int                                     not null,
    IsDeleted      tinyint(1)                              not null,
    CreatedOn      datetime(6)                             not null,
...
(
    Id        int auto_increment
        primary key,
    Name      varchar(450) collate utf8mb4_general_ci null,
    Note      longtext collate utf8mb4_general_ci     null,
    IsDeleted tinyint(1)                              not null,
    CreatedOn datetime(6)                             not null,
    UpdatedOn datetime(6)                             not null
...
(
    ...
    MetaKeywords             longtext collate utf8mb4_general_ci     null,
    MetaDescription          longtext collate utf8mb4_general_ci     null,
    ShortDescription         longtext collate utf8mb4_general_ci     null,
    Description              longtext collate utf8mb4_general_ci     null,
    Specification            longtext collate utf8mb4_general_ci     null,
    ...
    Sku                      varchar(450) collate utf8mb4_general_ci null,
    Gtin                     varchar(450) collate utf8mb4_general_ci null,
    NormalizedName           varchar(450) collate utf8mb4_general_ci null,
    ThumbnailImageId         int                                     null,
    ReviewsCount             int                                     not null,
    RatingAverage            double                                  null,
    BrandId                  int                                     null,
    Barcode                  longtext collate utf8mb4_general_ci     null,
    ValidThru                int                                     null,
    ...
    UnpublishedReason        longtext collate utf8mb4_general_ci     null,
...
(
    ...
    Description varchar(450) collate utf8mb4_general_ci null,
    IsDeleted   tinyint(1)                              not null,
    CreatedOn   datetime(6)                             not null,
    UpdatedOn   datetime(6)                             not null,
...
(
    ...
    ProductName     longtext collate utf8mb4_general_ci null,
    ProductMediaUrl longtext collate utf8mb4_general_ci null,
    Quantity        int                                 not null,
...
(
    ...
    CouponCode               longtext collate utf8mb4_general_ci null,
    CouponRuleName           longtext collate utf8mb4_general_ci null,
    ShippingMethod           longtext collate utf8mb4_general_ci null,
    IsProductPriceIncludeTax tinyint(1)                          not null,
    ShippingAmount           decimal(65, 30)                     null,
    ShippingData             longtext collate utf8mb4_general_ci null,
    OrderNote                longtext collate utf8mb4_general_ci null,
    IsDeleted                tinyint(1)                          not null,
    CreatedOn                datetime(6)                         not null,
    UpdatedOn                datetime(6)                         not null,
    CreatedById              int                                 not null,
...
(
    location_id int auto_increment comment '位置记录唯一标识'
        primary key,
    user_id     int                                not null comment '关联的用户ID',
    latitude    decimal(9, 6)                      not null comment '用户纬度',
    longitude   decimal(9, 6)                      not null comment '用户经度',
    created_at  datetime default CURRENT_TIMESTAMP null comment '位置记录创建时间',
